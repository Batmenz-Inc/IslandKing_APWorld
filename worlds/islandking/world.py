...
class IslandKingWorld(World):
    ...
    # Set the Options
    options_dataclass = islandking_options.IslandKingOptions
    options: islandking_options.IslandKingOptions # type: ignore
    ...
    def generate_early(self) -> None:
        if self.options.goal_type != self.options.goal_type.option_true_urban:
            raise NotImplementedError(f"Invalid yaml for Island King: goal_type {self.options.goal_type} is not implemented.")
